Optimized Lineage 2 Geo Data Blocks
...
Статья на хабре с описанием проделанной работы: https://habr.com/ru/articles/1000082/

Добавлен пример интеграции в L2J Mobius at module `l2jmobius_java21`
...
Отдельно надо отметить оптимизацию `Indexed32MultilayerBlock`, где используется индексация и доработанный алгоритм на основе
